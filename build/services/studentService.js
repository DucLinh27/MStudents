...
var postOrderCourses = function postOrderCourses(data) {
...
var postForgotPassword = function postForgotPassword(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var newPassword, user, hashedPassword, link;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            newPassword = Math.random().toString(36).slice(-8); // Find the user and update their password
            _context2.next = 8;
          ...
          case 14:
            ...
            return user.save();
          case 18:
            console.log("New password for user ".concat(user.email, " is ").concat(newPassword));

            // Send the new password to the user's email
            link = "Your new password is:".concat(user, " ").concat(newPassword, ". Please change it after logging in.");
            _context2.next = 22;
            return _emailService["default"].sendPasswordResetEmail({
              reciverEmail: data.email,
              link: link,
