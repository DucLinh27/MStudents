...
var authMiddleware = function authMiddleware(req, res, next) {
  ...
  _jsonwebtoken["default"].verify(accessToken.replace("Bearer ", ""), ACCESS_TOKEN_SECRET, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(err, user) {
      var refreshToken;
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            try {
              ...
              _jsonwebtoken["default"].verify(refreshToken, REFRESH_TOKEN_SECRET, /*#__PURE__*/function () {
